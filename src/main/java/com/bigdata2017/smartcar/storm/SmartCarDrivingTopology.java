...
public class SmartCarDrivingTopology {
	...
	public static void main(String[] args) throws AlreadyAliveException, InvalidTopologyException {
		...
		config.put( Config.NIMBUS_HOST, "lx02.bigdata.com" );
		config.put( Config.NIMBUS_THRIFT_PORT, 6627 );
		config.put( Config.STORM_ZOOKEEPER_PORT, 2181 );
		config.put( Config.STORM_ZOOKEEPER_SERVERS, Arrays.asList( "lx02.bigdata.com" ) );	
	...
	private static StormTopology makeTopology() {
		...
		// Spout(Kafka) 생성 및 등록
		BrokerHosts brokerHosts = new ZkHosts( "lx02.bigdata.com:2181" );
